...
def configureSection(frame0):
    ...
    configButton = tk.Button(frame0, text = 'Configure',  font=("",12,"bold"), background="#92D050", foreground="white")
    ...
    date=DateEntry(frame0,selectmode='day')
    date.grid(column=1, row=1, padx=5, pady=5, sticky='W')
